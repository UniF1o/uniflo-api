...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_application_jobs_application_id'), 'application_jobs', ['application_id'], unique=False)
    op.create_index(op.f('ix_application_jobs_status'), 'application_jobs', ['status'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_application_jobs_application_id'), table_name='application_jobs')
