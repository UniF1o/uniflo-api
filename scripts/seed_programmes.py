    ...
    with Session(engine) as session:
        ...
        for prog_data in programmes_data:
            ...
            if existing_prog:
                ...
                existing_prog.qualification_type = prog_data.get("qualification_type")
                existing_prog.duration_years = prog_data.get("duration_years")
                ...
                new_prog = Programme(
                    ...
                    qualification_type=prog_data.get("qualification_type"),
                    duration_years=prog_data.get("duration_years"),
